 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.base_app.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.baseApp'; // ios bundle id
const PACKAGE = 'com.baseApp'; // android package name
const NAME = 'BaseApp'; // app name
const EXPO_ACCOUNT_OWNER = 'mtnguyen2107'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'BaseApp'; // app scheme
